...
ace.define("ace/mode/jetx_highlight_rules",["require","exports","module","ace/lib/oop","ace/lib/lang","ace/mode/text_highlight_rules","ace/mode/html_highlight_rules"], function(require, exports, module) {
"use strict";
...
var JetxHighlightRules = function() {
    ...
    var builtinFunctions = lang.arrayToMap(
        ("now|random|UUID|range|fileGet|includeGet|macroGet|debug").split('|')
    );

    var builtinVariables = lang.arrayToMap(
        ('for|application|session|request|applicationScope|sessionScope|requestScope|param|paramValues|CONTEXT_PATH|WEBROOT|WEBROOT_PATH|BASE_PATH').split('|')
    );
    ...
    this.$rules.start.push(
        {
            ...
            token : "constant.numeric", // hex
            regex : "0[xX][0-9a-fA-F]+[lL]?\\b"
        }, {
            token : "constant.numeric", // float
            regex : "[+-]?\\d+(?:(?:\\.\\d*)?(?:[eE][+-]?\\d+)?)?[lLfFdD]?\\b"
        }, {
...
oop.inherits(JetxHighlightRules, TextHighlightRules);

exports.JetxHighlightRules = JetxHighlightRules;
});

ace.define("ace/mode/folding/jetx",["require","exports","module","ace/lib/oop","ace/mode/folding/fold_mode","ace/range"], function(require, exports, module) {
"use strict";
...
(function() {
    ...
    this.getFoldWidgetRange = function(session, foldStyle, row) {
        ...
        if (startLevel == -1 || (line[startLevel] != "##" && line[startLevel] != "#//"))
            return;
        ...
        while (++row < maxRow) {
            ...
            if (line[startLevel] != "##" && line[startLevel] != "#//")
                break;
    ...
    this.getFoldWidget = function(session, foldStyle, row) {
        ...
        if (prevIndent == -1) {
            if (indent == nextIndent && (line[indent] == "##" || line[indent] == "#//") && (next[indent] == "##" || next[indent] == "#//")) {
                session.foldWidgets[row - 1] = "";
                session.foldWidgets[row + 1] = "";
                return "start";
            }
        } else if (prevIndent == indent && (line[indent] == "##" || line[indent] == "#//") && (prev[indent] == "##" || prev[indent] == "#//")) {
...
ace.define("ace/mode/jetx",["require","exports","module","ace/lib/oop","ace/mode/html","ace/mode/jetx_highlight_rules","ace/mode/folding/jetx"], function(require, exports, module) {
"use strict";

var oop = require("../lib/oop");
var HtmlMode = require("./html").Mode;
var JetxHighlightRules = require("./jetx_highlight_rules").JetxHighlightRules;
var FoldMode = require("./folding/jetx").FoldMode;

var Mode = function() {
    HtmlMode.call(this);
    this.HighlightRules = JetxHighlightRules;
